...
/**
 * <p>
 * Implementation of the <a href="http://dev.w3.org/2006/waf/access-control/">cross-origin resource sharing</a>.
 * </p>
 * <p>
 ...
 * <ul>
 * <li><b>allowedOrigins</b>, a comma separated list of origins that are allowed to access the resources. Default value
 * is <b>*</b>, meaning all origins</li>
 * <li><b>allowedMethods</b>, a comma separated list of HTTP methods that are allowed to be used when accessing the
 * resources. Default value is <b>GET,POST</b></li>
 * <li><b>allowedHeaders</b>, a comma separated list of HTTP headers that are allowed to be specified when accessing the
 * resources. Default value is <b>X-Requested-With</b></li>
 * <li><b>preflightMaxAge</b>, the number of seconds that preflight requests can be cached by the client. Default value
 * is <b>1800</b> seconds, or 30 minutes</li>
 * <li><b>allowCredentials</b>, a boolean indicating if the resource allows requests with credentials. Default value is
 * <b>false</b></li>
 * </ul>
 * </p>
 * <p>
